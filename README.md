...
- 🌱 Learning and implementing concepts in `Backend Development` , `DevOps` and `Cloud`
- 💬 Ask me about **Backend Development , DevOps & Cloud**
- 🔧 Currently exploring **Kubernetes and Cloud deployments on cloud**
...
<div style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;">
  ...
  <img src="https://skillicons.dev/icons?i=laravel" width="50" height="50"/>
